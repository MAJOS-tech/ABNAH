...
This Cloudflare Worker is the secure backend for a GitHub Pages front end. It keeps the Zoho client secret and refresh token server-side, exposes only read-only ABNAH control-tower data, and never sends Zoho credentials to the browser.
...
- `FRONTEND_ORIGIN=https://majos-tech.github.io`
